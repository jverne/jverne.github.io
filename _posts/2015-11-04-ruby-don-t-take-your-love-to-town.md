...
As I alluded to in [an earlier posting]({% post_url 2015-10-27-ruby-tuesday %}) I've switched from Pragmatically learning Python (again!) to refreshing my Ruby and Rails skills (again!). There was a method to this madness; as of today I am officially a Ruby and Rails developer, working for a growing startup here in Sleepy University Town.
